...
const FROM = process.env.EMAIL_FROM || 'PropMaintain - Property maintenance request tracking and accountability platform for tenants <noreply@example.com>';
const APP_NAME = 'PropMaintain - Property maintenance request tracking and accountability platform for tenants';
