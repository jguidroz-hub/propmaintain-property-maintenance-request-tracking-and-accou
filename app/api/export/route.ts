  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="PropMaintain - Property maintenance request tracking and accountability platform for tenants-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
