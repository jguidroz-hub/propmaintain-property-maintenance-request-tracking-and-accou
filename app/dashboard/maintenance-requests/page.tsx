...
interface MaintenanceRequestsItem {
  id: string;
  title?: string;
  status?: string;
  createdAt: string;
...
export default function MaintenanceRequestsPage() {
  const [items, setItems] = useState<MaintenanceRequestsItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-6">Track and manage maintenance requests</p>
